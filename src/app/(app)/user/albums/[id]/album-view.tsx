...
import { addPhotosToAlbumAction, deletePhotoFromAlbumAction, editAlbumAction, EditAlbumInput, GetUserAlbumActionResponse } from "@/actions/album.actions";
...
export default function AlbumView({ album }: { album: NonNullable<GetUserAlbumActionResponse>}) {
  ...
  const [albumSettings, setAlbumSettings] = useState<EditAlbumInput>({
    title: album?.title,
    ...
    layout: album?.layout,
    gridColumns: album?.gridColumns || 3,
  });
